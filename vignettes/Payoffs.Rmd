...
To estimate the population-level cost of smoking cessation therapy, the distribution of commonly used pharmacologic and behavioral therapies was obtained from the MMWR study (DOI: 10.15585/mmwr.mm7329a1). The reported usage among individuals attempting to quit included:
