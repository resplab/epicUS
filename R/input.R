...
get_input <- function(age0 = 40,
  ...
  ### changed the values for l_inc_betas for US
  ...
  input$agent$l_inc_betas <- t(as.matrix(c(intercept = -3.5-input$global_parameters$closed_cohort*100, y = 0.002, y2 = 0.00001))) # intercept is the result of model calibration,
