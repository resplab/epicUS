...
Cset_settings_var <- function(name, value) {
    .Call(`_epicUS_Cset_settings_var`, name, value)
}
...
Cget_runtime_stats <- function() {
    .Call(`_epicUS_Cget_runtime_stats`)
}
...
mvrnormArma <- function(n, mu, sigma) {
    .Call(`_epicUS_mvrnormArma`, n, mu, sigma)
}

Xrexp <- function(n, rate) {
    .Call(`_epicUS_Xrexp`, n, rate)
}
...
Cset_input_var <- function(name, value) {
    .Call(`_epicUS_Cset_input_var`, name, value)
}
...
get_sample_output <- function(year, sex) {
    .Call(`_epicUS_get_sample_output`, year, sex)
}

Cget_agent <- function(id) {
    .Call(`_epicUS_Cget_agent`, id)
}
...
Cget_output_ex <- function() {
    .Call(`_epicUS_Cget_output_ex`)
}

Ccreate_agents <- function() {
    .Call(`_epicUS_Ccreate_agents`)
}
...
Cget_agent_events <- function(id) {
    .Call(`_epicUS_Cget_agent_events`, id)
}
...
Cget_events_by_type <- function(event_type) {
    .Call(`_epicUS_Cget_events_by_type`, event_type)
}
...
Cget_all_events_matrix <- function() {
    .Call(`_epicUS_Cget_all_events_matrix`)
}

Callocate_resources <- function() {
    .Call(`_epicUS_Callocate_resources`)
}

Cget_pointers <- function() {
    .Call(`_epicUS_Cget_pointers`)
}

Cdeallocate_resources <- function() {
    .Call(`_epicUS_Cdeallocate_resources`)
}

Cdeallocate_resources2 <- function() {
    .Call(`_epicUS_Cdeallocate_resources2`)
}

Cinit_session <- function() {
    .Call(`_epicUS_Cinit_session`)
}

Cmodel <- function(max_n_agents) {
    .Call(`_epicUS_Cmodel`, max_n_agents)
}
